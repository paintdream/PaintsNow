#include "DeferredLightingTextureEncodedRenderStage.h"
#include "../../../../SnowyStream/SnowyStream.h"
#include <sstream>

using namespace PaintsNow;

DeferredLightingTextureEncodedRenderStage::DeferredLightingTextureEncodedRenderStage(const String& s) : OutputColor(renderTargetDescription.colorStorages[0]), LoadDepth(renderTargetDescription.depthStorage) {
...
TObject<IReflect>& DeferredLightingTextureEncodedRenderStage::operator () (IReflect& reflect) {
...
void DeferredLightingTextureEncodedRenderStage::PreInitialize(Engine& engine, IRender::Queue* queue) {
...
void DeferredLightingTextureEncodedRenderStage::OnFrameUpdate(Engine& engine, IRender::Queue* queue) {
