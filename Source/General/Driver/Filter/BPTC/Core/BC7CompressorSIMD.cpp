...
ALIGN_SSE UINT kZeroVector[4] = { 0, 0, 0, 0 };
...
ALIGN_SSE UINT kByteValMask[4] = { 0xFF, 0xFF, 0xFF, 0xFF };
...
int BC7CompressionModeSIMD::MaxAnnealingIterations = 20; // This is a setting.
...
double BC7CompressionModeSIMD::CompressSingleColor(const RGBAVectorSIMD &p, RGBAVectorSIMD &p1, RGBAVectorSIMD &p2, int &bestPbitCombo) const {
	...
	for(int pbi = 0; pbi < GetNumPbitCombos(); pbi++) {
		...
		UINT dist = 0x0;
		UINT bestValI[kNumColorChannels] = { (UINT)-1, (UINT)-1, (UINT)-1, (UINT)-1 };
		UINT bestValJ[kNumColorChannels] = { (UINT)-1, (UINT)-1, (UINT)-1, (UINT)-1 };
...
ALIGN_SSE UINT kOneVec[4] = { 1, 1, 1, 1 };
...
static inline __m128i rand_dir()
{
	...
	ALIGN_SSE UINT mult[4] = { 214013, 17405, 214013, 0 }; 
	ALIGN_SSE UINT gadd[4] = { 2531011, 10395331, 13737667, 0 }; 
	ALIGN_SSE UINT masklo[4] = { RAND_MAX, RAND_MAX, RAND_MAX, RAND_MAX };
...
ALIGN_SSE UINT kSevenVec[4] = { 7, 7, 7, 7 };
ALIGN_SSE UINT kNegOneVec[4] = { 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF };
ALIGN_SSE UINT kFloatSignBit[4] = { 0x40000000, 0x40000000, 0x40000000, 0x40000000 };
